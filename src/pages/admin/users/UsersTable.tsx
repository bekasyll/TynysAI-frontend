    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      <table className="w-full text-sm table-fixed">
        <thead className="bg-gray-50 border-b border-gray-200">
          <tr>
            <th className="px-3 sm:px-6 py-3 text-left font-medium text-gray-500">{t('admin.col_user')}</th>
            <th className="hidden md:table-cell px-6 py-3 text-left font-medium text-gray-500 w-[120px]">{t('admin.col_role')}</th>
            <th className="hidden sm:table-cell px-4 sm:px-6 py-3 text-left font-medium text-gray-500 w-[120px]">{t('admin.col_status')}</th>
            <th className="hidden lg:table-cell px-6 py-3 text-left font-medium text-gray-500 w-[140px]">{t('admin.col_registered')}</th>
            <th className="px-2 sm:px-6 py-3 w-[50px] sm:w-[80px]"></th>
          </tr>
        </thead>
              ...
              <td className="px-3 sm:px-6 py-4">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="font-medium text-gray-900 break-words">{u.fullName}</p>
                    <p className="text-xs text-gray-500 flex flex-wrap items-center gap-1.5">
                      <span className="break-all">{u.email}</span>
                      {!u.emailVerified && (
                        <span className="inline-flex items-center gap-0.5 text-amber-600 text-[10px] font-medium uppercase tracking-wide shrink-0">
